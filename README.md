...
Hands-on AI projects from [GammaVibe on YouTube](https://www.youtube.com/@GammaVibeLab). Each project is a self-contained proof of concept you can clone and run.
...
Each project folder has its own README with setup instructions and a link to the corresponding video. Pick one and dive in.
